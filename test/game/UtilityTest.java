...
public class UtilityTest {
    ...
    public void shuffleArrayTest() {
        /* empty array */
        int arr[] = new int[0];
        int actuals[] = Utility.shuffleArray(arr);
        int expecteds[] = new int[0];
        assertArrayEquals(expecteds, actuals);
        
        /* size 1 */
        arr = new int[]{86};
        actuals = Utility.shuffleArray(arr);
    ...
    public void getTwoConsecutiveNumbers() {
        ...
        try {
            Utility.getTwoConsecutiveNumbers(shuffledArray);
        ...
        int actuals[] = Utility.getTwoConsecutiveNumbers(shuffledArray);
        int expectedC1 = 0;
        int expectedC2 = 1;
        ...
        actuals = Utility.getTwoConsecutiveNumbers(shuffledArray);
        expectedC1 = 1;
        expectedC2 = 0;
        assertEquals(expectedC1, actuals[0]);
        assertEquals(expectedC2, actuals[1]);
    ...
    public void convertPixelCoordsToSquareCoordsTest() {
        int actuals[] = Utility.convertPixelCoordsToSquareCoords(23, 22);
        int expecteds[] = new int[]{0, 0};
        assertArrayEquals(expecteds, actuals);
        
        actuals = Utility.convertPixelCoordsToSquareCoords(20, 50);
        expecteds = new int[]{0, 1};
        assertArrayEquals(expecteds, actuals);
        
        actuals = Utility.convertPixelCoordsToSquareCoords(50, 18);
        expecteds = new int[]{1, 0};
        assertArrayEquals(expecteds, actuals);
        
        actuals = Utility.convertPixelCoordsToSquareCoords(52, 49);
        expecteds = new int[]{1, 1};
        assertArrayEquals(expecteds, actuals);
        
        actuals = Utility.convertPixelCoordsToSquareCoords(85, 179);
